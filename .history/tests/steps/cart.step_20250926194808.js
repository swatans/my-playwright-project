...
Given('I open the Saucedemo login pages', async function () {
    // If other login steps already set this.loginPage, keep it.
    // But always ensure inventoryPage is available
